...
std::vector<float> BlockGemmCUDA(const std::vector<float>& a,
    ...
    cudaMemcpy(d_a, a.data(), countElem * sizeof(float), cudaMemcpyHostToDevice);
    cudaMemcpy(d_b, b.data(), countElem * sizeof(float), cudaMemcpyHostToDevice);
    ...
    cudaMemcpy(c.data(), d_c, countElem * sizeof(float), cudaMemcpyDeviceToHost);
